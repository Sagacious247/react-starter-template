...
function Header() {
  ...
  const [scrollPag, setScrollPage] = useState(false)
  ...
  return (
    <header className={scrollPag ? `${styles.fixed}` : null}>
      ...
      : `${styles["hide-nav"]}`}>
        ...
        <div onClick={hideMenu} className={styles["header-right"]}>
          <span className={styles.links}>
            ...
            <ShowOnLogin>
            <NavLink to="/" onClick={signoutUser}>Signout</NavLink>
            </ShowOnLogin>
          </span>
